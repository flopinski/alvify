$(function () {
  ...
  $(".goods-tabs__top-item").on("click", function (e) {
    ...
    $(".goods-tabs__content-item").removeClass(
      "goods-tabs__content-item--active"
    );
